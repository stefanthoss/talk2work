    ...
    RGraph.Line = function (id)
    {
        ...
        */
        ...
        this.properties = {
            ...
            'chart.background.grid.color':  null,
            ...
            'chart.colors':                 ['#00BFFF', '#0f0', '#00f', '#f0f', '#ff0', '#0ff','green','pink','blue','black'],
            'chart.hmargin':                0,
            'chart.tickmarks.dot.color':    '#00BFFF',
            ...
            'chart.text.size':              14,
            'chart.text.angle':             0,
            'chart.text.color':             '#9C9C9C',
            'chart.text.font':              'Open Sans',
            'chart.ymin':                   0,
            'chart.ymax':                   null,
            'chart.title':                  '',
